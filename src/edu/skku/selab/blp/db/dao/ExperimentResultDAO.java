...
public class ExperimentResultDAO extends BaseDAO {
	...
	public int insertExperimentResult(ExperimentResult experimentResult) {
		String sql = "INSERT INTO EXP_INFO (TOP1, TOP5, TOP10, TOP1_RATE, TOP5_RATE, TOP10_RATE, MRR, MAP, PROD_NAME, ALG_NAME, ALG_DESC, ALPHA, BETA, GAMMA, DELTA, PAST_DAYS, EXP_DATE) "
				+ "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
		...
		try {
			...
			ps.setDouble(15, experimentResult.getDelta());
			ps.setInt(16, experimentResult.getPastDays());
			ps.setString(17, experimentResult.getExperimentDateString());
	...
	public ExperimentResult getExperimentResult(String productName, String algorithmName) {
		...
		String sql = "SELECT TOP1, TOP5, TOP10, TOP1_RATE, TOP5_RATE, TOP10_RATE, MRR, MAP, ALG_DESC, ALPHA, BETA, GAMMA, DELTA, PAST_DAYS, EXP_DATE "+
				"FROM EXP_INFO " +
